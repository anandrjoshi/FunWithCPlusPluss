========================================================================
    ACTIVE TEMPLATE LIBRARY : HelloWorldATL Project Overview
========================================================================

AppWizard has created this HelloWorldATL project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

HelloWorldATL.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

HelloWorldATL.vcxproj.filters
...
HelloWorldATL.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (HelloWorldATL.h)
        GUID definitions                                (HelloWorldATL_i.c)
        A type library                                  (HelloWorldATL.tlb)
        Marshaling code                                 (HelloWorldATL_p.c and dlldata.c)

HelloWorldATL.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in HelloWorldATL.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named HelloWorldATL.pch and a precompiled types file named StdAfx.obj.
...
HelloWorldATLps.vcxproj
	...
	dlldata.c, HelloWorldATL_i.c and HelloWorldATL_p.c which are required
	to build the proxy/stub DLL.

HelloWorldATLps.vcxproj.filters
